...
public class SpawnStars : MonoBehaviour
{
    ...
    [SerializeField] private int rateGenerate = 10;
    ...
    void Update()
    {
        ...
        if (UnityEngine.Random.Range(0, rateGenerate) == 0)
        {
            var star = Instantiate(
                _prefabsStars[UnityEngine.Random.Range(0, _prefabsStars.Count)],
                new Vector3(GameManager.Instance.GenerateTransform.position.x, UnityEngine.Random.Range(-5f, 5f), 0f),
                Quaternion.identity,
